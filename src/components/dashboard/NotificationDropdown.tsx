    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute -right-2 sm:right-0 mt-3 w-[300px] sm:w-80 bg-white rounded-3xl border border-gray-100 shadow-2xl z-1000 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
