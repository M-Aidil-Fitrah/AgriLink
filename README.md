...
AgriLink merupakan aplikasi marketplace berbasis web yang dirancang untuk menghubungkan petani secara langsung dengan konsumen dalam satu platform terpadu.

Sistem ini berfokus pada:

Efisiensi distribusi hasil pertanian
Transparansi harga produk
Dukungan terhadap praktik pertanian berkelanjutan

Platform ini mengakomodasi dua jenis pengguna utama, yaitu petani sebagai penjual dan masyarakat umum sebagai pembeli.

Dengan pendekatan tersebut, AgriLink mampu:

Memotong rantai distribusi yang panjang
Memberikan keuntungan lebih adil bagi petani
Menyediakan produk yang lebih segar bagi konsumen

Selain itu, sistem ini mengintegrasikan konsep sustainable agriculture, melalui informasi seperti:
...
Pada tahap ini, sistem telah mencapai fase Minimum Viable Product (MVP) dengan capaian:

✅ Sistem autentikasi (login & registrasi)
✅ Fitur dasar marketplace (listing & detail produk)
✅ Dashboard sederhana untuk petani
✅ Struktur database dan relasi utama
✅ Repository GitHub aktif
✅ Dokumen URD & perancangan sistem
✅ Diagram (DFD, ERD, LRS)
✅ Flowchart dan algoritma utama

📌 Sistem sudah dapat dijalankan (running system) sesuai target UTS.
